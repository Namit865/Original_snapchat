...
class _Cloud {
  ...
  static const _assets = [
    "asset/plane_indicator/cloud1.png",
    "asset/plane_indicator/cloud2.png",
    "asset/plane_indicator/cloud3.png",
    "asset/plane_indicator/cloud4.png",
  ];
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final plane = AnimatedBuilder(
          ...
          child: Lottie.asset(
            "asset/plane_indicator/ghost.json",
